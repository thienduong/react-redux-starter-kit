        ...
        <nav className='navbar navbar-static-top' role='navigation'>
          ...
          <div className='navbar-custom-menu'>
            <ul className='nav navbar-nav'>
              ...
              <li className='dropdown messages-menu'>
                <Link to='/categories' activeClassName='page-layout__nav-item--active'>Categories</Link>
              </li>
                ...
                <ul className='dropdown-menu'>
                  ...
                  <li>
                    ...
                    <ul className='menu'>
                      ...
                      <li>
                        <a href='#'>
                          <i className='fa fa-warning text-yellow' /> Very long description here that may not fit into
                          the
